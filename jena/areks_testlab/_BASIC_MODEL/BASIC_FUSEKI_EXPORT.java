...
public class BASIC_FUSEKI_EXPORT {
	 ...
	 * @param accessor
	 */
	public BASIC_FUSEKI_EXPORT(DatasetAccessor accessor) {
		this.accessor = accessor;
		this.filepath = "";
	}
	 ...
	 * @param filepath
	 */
	public BASIC_FUSEKI_EXPORT(DatasetAccessor accessor, String filepath) {
		this.accessor = accessor;
		this.filepath = filepath;
	}
